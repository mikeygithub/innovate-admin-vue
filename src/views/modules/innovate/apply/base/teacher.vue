    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="applyBaseIsVisible(scope.row.projectInfoEntity)" type="text" size="small" @click="applyBaseHandle(scope.row.projectInfoEntity.projectId)">通过</el-button>
          <el-button v-if="applyBaseIsVisible(scope.row.projectInfoEntity)" type="text" size="small" @click="retreatHandle(scope.row.projectInfoEntity)">不通过</el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
