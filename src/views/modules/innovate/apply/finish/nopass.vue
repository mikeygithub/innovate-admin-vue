    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <el-button v-if="isAuth('innovate:finish:update')" type="text" size="small" @click="addOrUpdateHandle(scope.row.finishInfoEntity.finishId)">修改</el-button>
          <el-button v-if="isAuth('innovate:finish:list')" type="text" size="small" @click="retreatHandle(scope.row.finishInfoEntity.finishId)">不通过意见</el-button></template>
      </el-table-column>
    </el-table>
    <el-pagination
