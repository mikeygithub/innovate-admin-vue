<template>
  <el-dialog
    ...
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()" label-width="150px">
      <el-form-item label="评委组" prop="finishInfoEntity.groupId">
        <el-select v-model="dataForm.finishInfoEntity.groupId" placeholder="请选择">
          <el-option
          ...
          if (valid) {
            ...
            this.$http({
              ...
              data: this.$http.adornData({
                'groupId': this.dataForm.finishInfoEntity.groupId,
